const SHELL = 'jogahub-1.2.7';
const CONTENT = 'jogahub-1.2.7-content';
const SHELL_FILES = [
  './', './index.html', './instalar.html', './css/style.css?v=131', './js/data-jogos.js?v=40',
  './js/data-links.js?v=43', './js/data-filmes.js?v=129', './js/imdb-ratings.js?v=1', './js/data-tv.js?v=124', './js/offline-assets.js?v=40', './js/app.js?v=131',
  ...
  './assets/thumb-jogos-destaque.webp', './assets/thumb-trilha-da-floresta.webp', './assets/hero-trilha-da-floresta.webp', './assets/thumb-pixel-frontier.webp', './assets/hero-pixel-frontier.webp', './assets/thumb-kart-racer.webp', './assets/hero-kart-racer.webp', './assets/thumb-bomber-blast.webp', './assets/hero-bomber-blast.webp', './assets/thumb-crash-fan-game.webp', './assets/hero-crash-fan-game.webp', './assets/thumb-joao-crist.webp', './assets/hero-joao-crist.webp', './assets/thumb-zeco-lendas-da-ilha.webp', './assets/hero-zeco-lendas-da-ilha.webp', './assets/thumb-ruptura.webp', './assets/hero-ruptura.webp', './assets/icon-192.png', './assets/icon-512.png', './manifest.webmanifest?v=124'
];
