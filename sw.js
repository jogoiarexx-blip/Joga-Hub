const SHELL = 'jogahub-1.2.11';
const CONTENT = 'jogahub-1.2.11-content';
const SHELL_FILES = [
  './', './index.html', './instalar.html', './css/style.css?v=142', './js/data-jogos.js?v=40',
  './js/data-links.js?v=44', './js/data-filmes.js?v=130', './js/imdb-ratings.js?v=1', './js/data-tv.js?v=124', './js/offline-assets.js?v=40', './js/app.js?v=142',
