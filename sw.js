const SHELL = 'jogahub-1.5.2';
const CONTENT = 'jogahub-1.5.2-content';
const SHELL_FILES = [
  './', './index.html', './css/style.css?v=52', './js/data-jogos.js?v=40',
  './js/data-links.js?v=40', './js/data-filmes.js?v=52', './js/offline-assets.js?v=40', './js/app.js?v=52',
