const SHELL = 'jogahub-1.2.32';
const CONTENT = 'jogahub-1.2.32-content';
const SHELL_FILES = [
  ...
  './js/data-links.js?v=48', './js/data-arcana.js?v=1', './js/data-filmes.js?v=132', './js/imdb-ratings.js?v=1', './js/data-tv.js?v=125', './js/offline-assets.js?v=40', './js/app.js?v=144', './js/launcher-upgrade.js?v=125', './js/sidebar-upgrade.js?v=128', './js/responsive-layout.js?v=131', './js/header-upgrade.js?v=131',
