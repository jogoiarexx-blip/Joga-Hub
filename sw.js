const SHELL = 'jogahub-1.2.37';
const CONTENT = 'jogahub-1.2.37-content';
const SHELL_FILES = [
  './', './index.html', './instalar.html', './css/style.css?v=146', './css/hud-pro.css?v=125', './css/sidebar-upgrade.css?v=128', './css/responsive-layout.css?v=131', './css/header-upgrade.css?v=131', './css/player6.css?v=60', './js/data-jogos.js?v=40',
  './js/data-links.js?v=48', './js/data-arcana.js?v=3', './js/data-filmes.js?v=132', './js/data-drive-filmes.js?v=2', './js/imdb-ratings.js?v=2', './js/data-tv.js?v=125', './js/offline-assets.js?v=40', './js/app.js?v=146', './js/launcher-upgrade.js?v=125', './js/sidebar-upgrade.js?v=128', './js/responsive-layout.js?v=131', './js/header-upgrade.js?v=131',
