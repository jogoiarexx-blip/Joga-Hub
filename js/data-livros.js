...
const LIVROS = [
  {
    id: 'revenant-o-chamado-do-abismo', type: 'livro', title: 'Revenant — O Chamado do Abismo',
    genre: 'mangá • fantasia sombria', accent: 'var(--red)',
    thumb: 'assets/thumbs/revenant-o-chamado-do-abismo.webp',
    desc: 'Livro I em formato mangá: uma jornada sombria pelo Abismo, memórias, promessas e fragmentos de identidade.',
    path: 'livros/revenant-o-chamado-do-abismo/index.html'
  },
  {
    id: 'pantera-e-o-jardim-das-patinhas', type: 'livro', title: 'Pantera e o Jardim das Patinhas',
    genre: 'quadrinhos infantis', accent: 'var(--amber)',
    thumb: 'assets/thumbs/pantera-e-o-jardim-das-patinhas.webp',
    desc: 'Uma história infantil de Suelen Januário sobre amizade, saudade, fé e o amor que nunca termina.',
    path: 'livros/pantera-e-o-jardim-das-patinhas/index.html'
  },
  {
